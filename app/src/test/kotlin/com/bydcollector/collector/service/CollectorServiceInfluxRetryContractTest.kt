...
class CollectorServiceInfluxRetryContractTest {
    ...
    fun independentInfluxRetryUsesTheExistingServiceLifecycle() {
        ...
        assertTrue(noRuntime.contains("influxRequestQueued.get()"))
        assertTrue(noRuntime.contains("influxWorkInFlight.get() > 0"))
        assertTrue(noRuntime.contains("influxRetryScheduled"))
