...
class BydCollectorStringsTest {
    ...
    fun kpiLabelsLiveInUiStrings() {
        ...
        assertEquals("Парфум 1", uk.kpiPerfume1)
        assertEquals("Парфум 2", uk.kpiPerfume2)
        assertEquals("Парфум 3", uk.kpiPerfume3)
        assertEquals("Perfume 1", en.kpiPerfume1)
        assertEquals("Perfume 2", en.kpiPerfume2)
        assertEquals("Perfume 3", en.kpiPerfume3)
        assertEquals("Δ комірок", uk.kpiCellDelta)
        assertEquals("Cell Δ", en.kpiCellDelta)
