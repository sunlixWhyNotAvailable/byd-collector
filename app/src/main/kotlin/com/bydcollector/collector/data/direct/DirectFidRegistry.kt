...
object DirectFidRegistry {
    ...
    val entries: List<DirectFidEntry> = listOf(
        ...
        DirectFidEntry("charging_charging_charge_current_not_convert", 1009, -1002438632, TX_GET_FLOAT, DirectValueDecoder.FLOAT_RAW, groupName = "direct_charging", featureNames = "Charging.CHARGING_CHARGE_CURRENT_NOT_CONVERT", classification = "vehicle_energy_candidate", prodCategory = "charging_energy", source = "wide-poll-session-20260605_161751"),
        ...
        DirectFidEntry("power_low_voltage", 1005, 315621437, TX_GET_INT, DirectValueDecoder.INT_RAW, groupName = "direct_power", featureNames = "POWER_LOW_VOLTAGE;Power.POWER_LOW_VOLTAGE", classification = "vehicle_energy_candidate", prodCategory = "charging_energy", source = "wide-poll-session-20260605_161751"),
        ...
        DirectFidEntry("statistic_remaining_battery_power", 1014, 1148190760, TX_GET_INT, DirectValueDecoder.INT_RAW, groupName = "direct_statistic", featureNames = "STATISTIC_REMAINING_BATTERY_POWER;Statistic.STATISTIC_REMAINING_BATTERY_POWER", classification = "vehicle_energy_candidate", prodCategory = "charging_energy", source = "wide-poll-session-20260605_161751"),
        ...
        DirectFidEntry("statistic_1014_877658152_5", 1014, 877658152, TX_GET_INT, DirectValueDecoder.INT_RAW, groupName = "direct_statistic", featureNames = "STATISTIC_MAX_CHARGE_CURRENT_ALLOW;Statistic.STATISTIC_MAX_CHARGE_CURRENT_ALLOW", classification = "round_robin_promoted_20260613", prodCategory = "charging_energy", source = "wide-poll-session-20260605_161751"),
    )
}
