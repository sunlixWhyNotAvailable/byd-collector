...
data class TelegramStrings(
    ...
    val templateLimitWarning: String,
    val templateLimitWithLocation: String,
...
data class UiStrings(
    ...
    val kpiSoc: String,
    val kpiEnergyLeft: String,
    val kpiOdometer: String,
    val kpiCabinTemp: String,
    val kpiPerfume1: String,
    val kpiPerfume2: String,
    val kpiPerfume3: String,
    val kpiSoh: String,
    ...
    val alternativeProfile: String,
    val activeProfile: String,
    val connectionProfile: String,
    val stopChannelToEdit: String,
    ...
    val batteryNet: String,
    val averageConsumption: String,
    val route: String,
    val noTrips: String,
    val currentTrip: String,
    val noCurrentTrip: String,
    val startNow: String,
    val now: String,
    val partial: String,
    val currentTripUpdatedAt: String,
    val currentTripActive: String,
    val currentTripCompleted: String,
    val tripRoute: String,
    val colorBySpeed: String,
    val colorByConsumption: String,
    val tripStart: String,
    val tripFinish: String,
    val tripCurrentPosition: String,
    val tripLastKnownPosition: String,
    val tripNoData: String,
    val compressDatabase: String,
    val tripsCompressionTitle: String,
    val tripsCompressionConfirm: String,
    val tripsCompressionWarning: String,
    val tripsCompressionSteps: List<String>,
    val tripsCompressionComplete: String,
    val tripsCompressionNoSavings: String,
    val tripsCompressionSaved: String,
    val tripsCompressionFailed: String,
    val restoreConnectivity: String,
    ...
    val updateHintTitle: String,
    val updateHintDescription: String,
    ...
    val clearLogsScope: String,
    val clearLogsIrreversible: String,
    val clearLogsConfirm: String,
    val logsCleared: String,
    val logsPartiallyCleared: String,
    val logsShareFailed: String,
    val logsClearFailed: String,
    ...
    val dbMaintenanceTelegramStorageWarningTemplate: String,
...
private val telegramUk = TelegramStrings(
    ...
    templateLimitWarning = "Перевищено обмеження шаблону 4 096 символів",
    templateLimitWithLocation = "Перевищено обмеження шаблону 4 096 символів із локацією",
    minuteUnit = "хв",
    secondUnit = "с",
    messages = mapOf(
        ...
        TelegramMessageType.LOW_12V_VOLTAGE to TelegramMessageStrings(
            "Низька напруга 12V акумулятора",
    ...
    variableDescriptions = mapOf(
        ...
        "time" to "Час події, dd.MM.yyyy HH:mm",
        "battery_12v" to "Напруга 12V акумулятора, В",
        ...
        "trip_discharged_kwh" to "Витрачено за переїзд, кВт·год",
        "trip_regenerated_kwh" to "Рекуперовано за переїзд, кВт·год",
        ...
        "total_discharged_kwh" to "Витрачено за сесію, кВт·год",
        "total_regenerated_kwh" to "Рекуперовано за сесію, кВт·год",
...
private val telegramEn = TelegramStrings(
    ...
    templateLimitWarning = "Template exceeds the 4,096-character limit",
    templateLimitWithLocation = "Template exceeds the 4,096-character limit with location",
    minuteUnit = "min",
    secondUnit = "sec",
    messages = mapOf(
        TelegramMessageType.CHARGING_STARTED to TelegramMessageStrings(
    ...
    variableDescriptions = mapOf(
        ...
        "time" to "Event time, dd.MM.yyyy HH:mm",
        ...
        "trip_discharged_kwh" to "Drive energy used, kWh",
        "trip_regenerated_kwh" to "Drive energy recovered, kWh",
        ...
        "total_discharged_kwh" to "Power-session energy used, kWh",
        "total_regenerated_kwh" to "Power-session energy recovered, kWh",
...
private fun buildStrings(language: UiLanguage): UiStrings {
    return when (language) {
        UiLanguage.UK -> UiStrings(
            ...
            allSubtitle = "Вторинний збір додаткових параметрів.",
            ...
            extraSubtitle = "Окремі налаштування",
            dataCollection = "Збір даних",
            archiveDatabase = "Архівація бази",
            archiveDebugDatabase = "Архівація вторинної бази",
            grantAdb = "Видати ADB",
            ...
            activeDatabaseSizeTemplate = "%s: основна %s + вторинна %s + поїздки %s",
            mainStorageCutoverDeferred = "Перехід основної бази відкладено до ручної архівації.",
            mainStorageCutoverErrorTemplate = "Основна база: %s",
            debugStorageCutoverErrorTemplate = "База «Всі дані»: %s",
            ...
            points = "точок",
            queued = "У черзі",
            primaryProfile = "Основний",
            alternativeProfile = "Альтернативний",
            activeProfile = "зараз",
            connectionProfile = "Профіль підключення",
            stopChannelToEdit = "Зупиніть канал, щоб змінити підключення.",
            invalidEndpoint = "Вкажіть хост і порт від 1 до 65535. Альтернативну пару можна залишити порожньою.",
            exported = "Експортовано",
            currentVehicleState = "Поточний стан авто",
            kpiSoc = "SOC",
            kpiEnergyLeft = "Залишок енергії",
            kpiOdometer = "Пробіг",
            kpiCabinTemp = "Темп. салону",
            kpiPerfume1 = "Парфум 1",
            kpiPerfume2 = "Парфум 2",
            kpiPerfume3 = "Парфум 3",
            kpiSoh = "SOH",
            kpiCharging = "Заряджання",
            kpiDischarging = "Розряджання",
            kpiRange = "Запас ходу",
            kpiBatteryTemp = "Темп. батареї",
            kpiCellDelta = "Δ комірок",
            ...
            distance = "Відстань",
            used = "Витрачено",
            recovered = "Рекуперовано",
            batteryNet = "Баланс АКБ",
            averageConsumption = "Середня витрата",
            route = "Маршрут",
            noTrips = "Поїздок ще немає",
            currentTrip = "Поточна поїздка",
            noCurrentTrip = "Немає поточної поїздки",
            startNow = "Початок → Зараз",
            now = "зараз",
            partial = "частково",
            currentTripUpdatedAt = "Дані станом на %s",
            currentTripActive = "Поточні дані поїздки",
            currentTripCompleted = "Поїздку завершено",
            tripRoute = "Маршрут поїздки",
            colorBySpeed = "Колір за швидкістю",
            colorByConsumption = "Колір за витратою",
            tripStart = "Початок",
            tripFinish = "Кінець",
            tripCurrentPosition = "Поточна позиція",
            tripLastKnownPosition = "Остання відома позиція",
            tripNoData = "Відсутні дані",
            compressDatabase = "Стиснення бази",
            tripsCompressionTitle = "Стиснення бази поїздок",
            tripsCompressionConfirm = "Стиснути базу поїздок?",
            tripsCompressionWarning = "Стиснення без втрати даних: усі поїздки й точки маршрутів зберігаються, історія та мапи доступні. Поточна поїздка не переривається.",
            tripsCompressionSteps = listOf(
                "Готуємо стиснення...", "Стискаємо дані завершених поїздок...",
                "Перевіряємо збереження всіх точок...", "Зберігаємо стиснені дані...",
                "Оновлюємо розмір бази...", "Завершуємо стиснення..."
            ),
            tripsCompressionComplete = "Стиснення завершено",
            tripsCompressionNoSavings = "Додаткове стиснення не зменшило розмір. Поточну базу збережено.",
            tripsCompressionSaved = "Звільнено: %s",
            tripsCompressionFailed = "Стиснення не завершено. Деталі в логах.",
            restoreConnectivity = "Відновлювати Wi-Fi та моб. зв'язок",
            keepBluetooth = "Відновлювати Bluetooth",
            ...
            updateHintTitle = "Віджет-підказка нової версії",
            updateHintDescription = "Показувати 10 секунд, коли перевірка знаходить оновлення",
            ...
            shareLogs = "Поділитись логами",
            clearLogs = "Очистити логи",
            clearLogsTitle = "Очистити логи?",
            clearLogsScope = "Буде видалено завершені записи logcat, журнал подій, підготовлені архіви та журнал helper. Активний запис logcat не зупиниться.",
            clearLogsIrreversible = "Цю дію неможливо скасувати.",
            clearLogsConfirm = "Очистити",
            logsCleared = "Старі логи очищено",
            logsPartiallyCleared = "Локальні логи очищено; helper-лог недоступний",
            logsShareFailed = "Не вдалося підготувати логи",
            logsClearFailed = "Не вдалося очистити логи",
        ...
        UiLanguage.EN -> UiStrings(
            ...
            allSubtitle = "Secondary collection of additional parameters.",
            ...
            extraSubtitle = "Separate settings",
            dataCollection = "Data collection",
            archiveDatabase = "Archive database",
            archiveDebugDatabase = "Archive secondary database",
            grantAdb = "Grant ADB",
            ...
            activeDatabaseSizeTemplate = "%s: main %s + secondary %s + trips %s",
            mainStorageCutoverDeferred = "Main database transition deferred until manual archive.",
            mainStorageCutoverErrorTemplate = "Main database: %s",
            debugStorageCutoverErrorTemplate = "All data database: %s",
            ...
            alternativeProfile = "Alternative",
            activeProfile = "active",
            connectionProfile = "Connection profile",
            stopChannelToEdit = "Stop the channel to edit its connection.",
            invalidEndpoint = "Enter a host and port from 1 to 65535. The alternative pair may be left empty.",
            exported = "Exported",
            currentVehicleState = "Current vehicle state",
            kpiSoc = "SOC",
            kpiEnergyLeft = "Energy left",
            kpiOdometer = "Odometer",
            kpiCabinTemp = "Cabin temp",
            kpiPerfume1 = "Perfume 1",
            kpiPerfume2 = "Perfume 2",
            kpiPerfume3 = "Perfume 3",
            kpiSoh = "SOH",
            ...
            now = "now",
            partial = "partial",
            currentTripUpdatedAt = "Data as of %s",
            currentTripActive = "Current trip data",
            currentTripCompleted = "Trip completed",
            tripRoute = "Trip route",
            colorBySpeed = "Color by speed",
            colorByConsumption = "Color by consumption",
            tripStart = "Start",
            tripFinish = "Finish",
            tripCurrentPosition = "Current position",
            tripLastKnownPosition = "Last known position",
            tripNoData = "No data",
            compressDatabase = "Compress database",
            tripsCompressionTitle = "Compress Trips database",
            tripsCompressionConfirm = "Compress the Trips database?",
            tripsCompressionWarning = "Lossless compression keeps all trips and route points, with history and maps available. The current trip is not interrupted.",
            tripsCompressionSteps = listOf(
                "Preparing compression...", "Compressing completed trips...",
                "Verifying all route points are preserved...", "Saving compressed data...",
                "Updating database size...", "Finishing compression..."
            ),
            tripsCompressionComplete = "Compression complete",
            tripsCompressionNoSavings = "Further compression did not reduce the size. The current database was retained.",
            tripsCompressionSaved = "Space saved: %s",
            tripsCompressionFailed = "Compression did not complete. See logs for details.",
            restoreConnectivity = "Restore Wi-Fi and cellular",
            keepBluetooth = "Restore Bluetooth",
            restoreCollector = "Restore collector service",
            ...
            updateHintTitle = "New version hint widget",
            updateHintDescription = "Show for 10 seconds when a check finds an update",
            ...
            clearLogsScope = "Completed logcat captures, the event journal, prepared bundles, and the helper log will be cleared. An active logcat capture will not stop.",
            clearLogsIrreversible = "This action cannot be undone.",
            clearLogsConfirm = "Clear",
            logsCleared = "Old logs cleared",
            logsPartiallyCleared = "Local logs cleared; helper log unavailable",
            logsShareFailed = "Could not prepare logs",
