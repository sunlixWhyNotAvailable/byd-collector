...
Локація у підсумку поїздки за замовчуванням вимкнена. Окрема кнопка `Надсилати локацію` відкриває блокувальну модалку з незалежним вибором Google, Waze, Apple та OSM; можна не вибрати жодного посилання. Після ввімкнення той самий текст підсумку отримує останню довірену координату, її вік від оригінального часу фіксації та лише вибрані посилання; другого Telegram-повідомлення або медіа не створюється.
