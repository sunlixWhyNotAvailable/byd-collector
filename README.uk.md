...
Маршрут записується через Android GPS після надання дозволу на локацію. Під час послідовного першого налаштування застосунок один раз запитує fine/coarse location перед кроком авторизації ADB; після відмови доступ треба надати пізніше в системних налаштуваннях Android. Mock, невалідні, застарілі, неузгоджені за часом або фізично неможливі точки зберігаються лише як діагностика та стають розривами маршруту. Після відхилення, паузи callback або перезапуску джерела локації потрібні три взаємно узгоджені свіжі точки, щоб знову довіряти локації. Мапа використовує онлайн-тайли OpenStreetMap, вміщує довірений маршрут і може фарбувати сегменти за швидкістю або миттєвою витратою. Компактна синя точка позначає початок, нейтральне коло з білим прапорцем — кінець; відповідна локалізована легенда розташована в нижньому рядку керування. За замовчуванням використовується швидкість із порогами `90/30 км/год`; пороги витрати — `15/20 кВт·год/100 км`.
