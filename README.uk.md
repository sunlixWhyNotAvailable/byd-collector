...
- Перша перевірка `v2.7.0` на фізичному автомобілі виявила збій SQLite-spool під shell UID і відсутній автоматичний запит локації. Поточний кандидат замінює shell SQLite перевіреним файловим spool і додає послідовний одноразовий запит дозволу; ці виправлення перевірені на хості, але ще потребують встановлення та повторної перевірки на автомобілі.
