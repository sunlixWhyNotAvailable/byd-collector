...
Таблиця окремо показує витрачену з АКБ енергію, рекуперовану під час руху та баланс АКБ (витрачено мінус рекуперовано). Середня витрата рахується за балансом і може бути від’ємною. Ці розрахункові значення також доступні в категорії «Батарея» для MQTT та InfluxDB. Пропуски не заповнюються припущеннями про потужність; неповні нові розрахунки позначаються як часткові. Старі поїздки зберігають попереднє значення енергії як баланс АКБ та відповідну середню витрату; недоступні витрачена й рекуперована енергія показуються прочерками.
